		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#exprograme20-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"exprograme20-display": {
								"semanticObject": "exprograme20",
								"action": "display",
								"description": "Exam",
								"title": "App Title",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exprograme20",
									"url": sap.ui.require.toUrl("exprograme20")
								}
							}
						}
					}
